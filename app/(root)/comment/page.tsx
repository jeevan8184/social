...
const CommentSection = () => {
  ...
  return (
       <section className=' px-2 py-6 pb-36 flex flex-col gap-3'>
          ...
          <div className=' flex flex-col'>
            <div className=' flex gap-2'>
                ...
                <div className=' flex flex-col gap-2'>
                    ...
                    <p className=' font-[550] text-clip max-w-sm'>{post.text}</p>
                    <div className=''>
            ...
            <div className=' flex gap-2 my-3 h-full'>
                ...
                <div className=' flex flex-col gap-2 w-full'>
                    <div className=' flex flex-col gap-0'>
                        ...
                        <p className=' text-sm text-gray-500'>{currUser?.bio}</p>
                    </div>
                    <Textarea 
                        ...
                        className=' placeholder:text-gray-600 rounded-xl mx-0 pl-6 min-h-10 bg-grey-50 dark:bg-dark-4 
                            border-none max-w-md max-h-16 no-scrollbar' 
                        value={text}
